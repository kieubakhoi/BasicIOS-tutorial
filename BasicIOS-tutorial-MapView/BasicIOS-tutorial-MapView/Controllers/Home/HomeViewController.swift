...
//        let eiffelTowerLocation = CLLocation(latitude: 48.858042, longitude: 2.294793)
    ...
    func center(localtion: CLLocation) {
        
        // center
        mapView.setCenter(localtion.coordinate, animated: true)
        
        //zoom
//        let span = MKCoordinateSpan(latitudeDelta: 0.005, longitudeDelta: 0.005)
//        let region = MKCoordinateRegion(center: localtion.coordinate, span: span)
//
